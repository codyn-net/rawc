...
namespace Cpg.RawC.Programmer.Formatters.C
{
	public class Context
	{
		...
		public static string MathFunctionDefine(Cpg.InstructionFunction instruction)
		{
			return MathFunctionDefine((Cpg.MathFunctionType)instruction.Id, instruction.Arguments);
		}
		
		public static string MathFunctionDefine(Cpg.MathFunctionType type, int arguments)
		{
			...
			switch (type)
			{
				...
				case MathFunctionType.Rand:
					val = String.Format("CPG_MATH_{0}", name.ToUpper());
				break;
				default:
